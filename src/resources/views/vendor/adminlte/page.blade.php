                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                ...
                                <li class="user-footer">
                                    ...
                                    @if(session('currency_id'))
                                        <a class="btn btn-default btn-flat float-right @if(!$profile_url)btn-block @endif" href="{{ route('admin.tenants.sigin', session('currency_id', auth()->user()->tenant_id)) }}">
                                            <i class="fa fa-fw fa-share"></i> {{ __('adminlte::adminlte.sigin') }}
                                        </a>
                                    @endif
